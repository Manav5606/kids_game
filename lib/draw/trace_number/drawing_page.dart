...
EdgeInsets determinePadding(int index) {
  ...
  //                         textStyle: TextStyle(fontSize: MediaQuery.of(context).size.height*0.35
  //                       ),
  //                       ),
  //                     )),
  //               );
        ...
        body: LayoutBuilder(builder: (context, constraints) {
          ...
          return GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                //  color: Colors.red,
                    child: Padding(
                      padding: (numm >= 10) ? EdgeInsets.only(left:MediaQuery.of(context).size.width/3) : EdgeInsets.only(left:MediaQuery.of(context).size.width/1.55),
                      child: Row(
                        ...
                        children: [
                          Text(
                            ...
                            text[index],
                            style:  GoogleFonts.ralewayDots(
                              textStyle: TextStyle(fontSize: MediaQuery.of(context).size.height*0.7
                            ),
                            ),
                          ),
                        ],
          ...
          return GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  ...
                  width: 400,
                    child: Padding(
                      padding: determinePadding(index),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
