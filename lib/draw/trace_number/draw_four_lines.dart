              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Divider(color: Colors.white,height: MediaQuery.of(context).size.height * 0.025,),
                    ...
                    Divider(color: Colors.white,height: MediaQuery.of(context).size.height * 0.03,),
                    Column(
                      children: [
                    Container(
                      height: 1,
      ...
      child: Column(
        children: [
          Column(
            children: [
              Padding(
                padding: EdgeInsets.only(top:MediaQuery.of(context).size.height * 0.14,right: MediaQuery.of(context).size.width * 0.15),
                child: Column(
                  children: [
                    Column(
                      children: [
